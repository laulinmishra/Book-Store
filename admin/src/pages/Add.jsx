...
const Add = ({ token }) => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(`${backend_url}/api/product/create`, formData, {
        headers: { token },
      });
        ...
        <div className="flex items-end gap-x-6">
          ...
          <div>
            ...
            <select
              ...
              value={category}
              className="px-3 py-2 ring-1 ring-slate-900/10 rounded bg-white mt-1 sm:w-full text-gray-30 cursor-pointer"
            >
          ...
          <div className="flex gap-x-2 pt-2">
            <label htmlFor="image">
              <img
                ...
                alt=""
                className="w-14 h-14 aspect-square object-cover ring-1 ring-slate-900/5 bg-white rounded-lg cursor-pointer"
              />
