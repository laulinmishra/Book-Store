...
//     if(search) {
//       filtered = filtered.filter((book) => book.name.toLowerCase().includes(search.toLocaleLowerCase()))
//     }
...
//         <h4 className='h4 mb-4 hidden sm:flex '>Catrgoires:</h4>
...
//       <div className='mt-8'>
//         {/* title and sort */}
//         <div className='flexBetween !items-start gap-7 flex-wrp pb-16 max-sm:flexCenter text-center'>
//           <Title title1={'Our '} title2={'Book List'} titleStyles={'pb-0 text-start'} parasStyles={'!block'} />
          ...
          <div className='flexBetween !items-start gap-7 flex-wrp pb-16 max-sm:flexCenter text-center'>
            <div className='text-start'>
              <Title
                ...
                parasStyles={'!block'}
              />
              <p className='text-gray-500 medium-14 mt-2'>
